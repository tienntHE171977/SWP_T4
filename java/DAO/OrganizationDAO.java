...
public class OrganizationDAO {
    ...
    public void insertOrganization(Organization organization) throws SQLException {
        try (Connection connection = DBConnection.getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement(INSERT_ORGANIZATION_SQL, Statement.RETURN_GENERATED_KEYS)) {
    ...
    public Organization selectOrganization(int id) {
        ...
        try (Connection connection = DBConnection.getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement(SELECT_ORGANIZATION_BY_ID)) {
    ...
    public List<Organization> selectAllOrganizations() {
        ...
        try (Connection connection = DBConnection.getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement(SELECT_ALL_ORGANIZATIONS)) {
            ResultSet rs = preparedStatement.executeQuery();
    ...
    public boolean updateOrganization(Organization organization) throws SQLException {
        boolean rowUpdated;
        try (Connection connection = DBConnection.getConnection();
             PreparedStatement statement = connection.prepareStatement(UPDATE_ORGANIZATION_SQL)) {
