                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-12 d-flex align-items-center gap-2 pb-3">
                                                                ...
                                                                <form action="AddBlog" method="get" class="ms-auto">
                                                                    <button type="submit" class="btn btn-success">Bài viết mới</button>
                                                                </form>

                                                                <!-- Category Button -->
                                                                <form action="BlogCategories_1" method="get" class="ms-2">
                                                                    <button type="submit" class="btn btn-success">Danh mục</button>
                                                                </form>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-12 d-flex align-items-center gap-2">
                                                                ...
                                                                <form action="StatusBlog" method="post" class="d-flex align-items-center">
                                                                    <label for="by" class="mb-0 me-2">Trạng thái:</label>
                                                                    <select id="by" name="by" class="form-select me-2">
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="demo">
                                                                        <ul class="pagination pg-primary justify-content-end">
                                                                            <li class="page-item">
                                                                                <a class="page-link" href="?index=${tag > 1 ? tag - 1 : 1}&txt=${txtS}&cateID=${categoryID}&sortby=${sortby}&by=${by}"" aria-label="Previous">
                                                                            ...
                                                                            <c:forEach begin="1" end="${endP}" var="i">
                                                                                <li class="${tag == i ? 'active' : ''}">
                                                                                    <a href="?index=${i}&txt=${txtS}&cateID=${categoryID}&sortby=${sortby}&by=${by}" class="page-link">${i}</a>
                                                                                </li>
                                                                            </c:forEach>

                                                                            <li class="page-item">
                                                                                <a class="page-link" href="?index=${tag < endP ? tag + 1 : endP}&txt=${txtS}&cateID=${categoryID}&sortby=${sortby}&by=${by}" aria-label="Next">
