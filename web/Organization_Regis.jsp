            ...
            <form id="registerForm" action="regisorg" method="post" enctype="multipart/form-data">
                <div class="page" id="page1">
                    <div class="RegSectionHeader">
                        Part 1: General information of the organization *
                    </div>
                    ...
                    <div class="RegFormGroup">
                        ...
                        <input type="text" id="orgName" name="orgName" placeholder="Enter the full name of the organization" required>
                    ...
                    <div class="RegFormGroup">
                        ...
                        <input type="text" id="created_by" name="created_by" value="${user.getUsername()}" disabled>
