                                    ...
                                    <nav>
                                        <ul id="navigation">
                                            ...
                                            <li><a href="#">pages <i class="ti-angle-down"></i></a>
                                                <ul class="submenu">
                                                    <li><a href="ManageProjects.jsp">Manage Project</a></li>
                                                    <li><a href="RegisterProjects.jsp">Register Project</a></li>
                                                </ul>
                                            </li>
                    ...
                    <div class="col-lg-8">
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <a href="${pageContext.request.contextPath}/editProfile?id=${userProfile.id}" class="btn btn-primary">Edit</a>
