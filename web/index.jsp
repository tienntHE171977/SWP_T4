    ...
    <body>
        ...
        <form id="f1" action="home" method="get">
                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                <div class="slider_text">
                                    ...
                                    <h3>Giúp đỡ trẻ em
                                        Khi các em cần</h3>
                                    <p>Với rất nhiều thông tin cần tiêu thụ và thời gian hạn chế, việc đưa ra <br>
                                        các ý tưởng tiêu đề phù hợp là điều cần thiết</p>
            ...
            <div class="filter-bar">
                ...
                <c:if test="${userOr.getOrganizationStatus() == 'active'}">
                    <a href="login" class="crtprj-btn">Tạo dự án</a>
                </c:if>
                <c:if test="${userOr.getOrganizationStatus() != 'active' || empty userOr}">
                    <div onclick="RejectAction('organempty')" class="crtprj-btn">Tạo dự án</div>
                </c:if>
            </div>
            ...
            <div class="popular_causes_area section_padding">
                <div class="container">
                    ...
                    <c:if var="c" test="${requestScope.campaigns.isEmpty()}">
                        <h3 style="font-family: serif; color: #666; text-align: center; font-weight: bold">Chúng tôi không tìm thấy kết quả nào</h3>
                        <h4 style="font-family: serif; color: #666; text-align: center">Hãy chắc chắn rằng tất cả các từ được viết đúng chính tả hoặc thử một từ khóa khác</h4>
                    </c:if>
                    <div class="row">
                        <div class="col-lg-12">
                                ...
                                <c:forEach var="c" items="${requestScope.campaigns}">
                                    <div class="single_cause">
                                        ...
                                        <div class="causes_content">
                                            <div class="custom_progress_bar">
                                                <div class="progress">
                                                    <div class="progress-bar" role="progressbar" style=" width: 100%;">
                                                        <!-- Placeholder for progress count -->
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="balance d-flex justify-content-between align-items-center">
                                                <span><a style="font-weight: bold;color: darkseagreen">Bắt đầu:</a> ${c.getStartDate()}</span>
                                                <span><a style="font-weight: bold;color: darkseagreen">Kết thúc:</a> ${c.getEndDate()}</span>
                                            </div>
                                            ...
                                            <a class="read_more" href="project-details?id=${c.projectId}">Đọc thêm</a>
                                        </div>
                                    </div>
                                </c:forEach>
                                <!--<div id="results"></div>-->
                                ...
                                <c:forEach var="ev" items="${requestScope.events}">
                                    <div class="single_cause">
                                        ...
                                        <div class="causes_content">
                                            ...
                                            <div class="balance d-flex justify-content-between align-items-center">
                                                <span><a style="font-weight: bold;color: darkseagreen">Bắt đầu:</a> ${ev.getStartDate()}</span>
                                                <span><a style="font-weight: bold;color: darkseagreen">Kết thúc:</a> ${ev.getEndDate()}</span>
                                            </div>
                                            ...
                                            <a class="read_more" href="cause_details.html">Đọc thêm</a>
                                        </div>
                                    </div>
                                </c:forEach>
                                <!--<div id="results"></div>-->
            ...
            <div class="our_volunteer_area section_padding">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            <div class="section_title text-center mb-55">
                                <h3><span>Tình Nguyện Viên Của Chúng Tôi</span></h3>
                            </div>
                        </div>
                    </div>
                    <div class="row justify-content-center">
            ...
            <div style="text-align: center; margin-bottom: 30px">
                <c:if test="${(user.role) == 'volunteer'}">
                    <div style="display: flex; justify-content: center">
                        <div style="color: white" onclick="RejectAction('volunteerexist')" class="campaign-btn">Trở thành tình nguyện viên</div>
                    </div>
                </c:if>

                <c:if test="${(user.role) != 'volunteer'&& yourcv == null}">
                    <a href="volunteerregis" class="campaign-btn">Trở thành tình nguyện viên</a>
                </c:if>
                <c:if test="${(user.role) != 'volunteer' && yourcv != null}">
                    <div style="display: flex; justify-content: center">
                        <div style="color: white" onclick="RejectAction('volunteersentcv')" class="campaign-btn">Trở thành tình nguyện viên</div>
                    </div>
                </c:if>
            </div>
            ...
            <div class="news__area section_padding">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            <div class="section_title text-center mb-55">
                                <h3><span>Tin Tức & Cập Nhật</span></h3>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                                ...
                                <c:forEach var="be" items="${requestScope.news}">
                                    <div class="single__blog d-flex align-items-center">
                                        ...
                                        <div class="newsinfo">
                                            ...
                                            <a class="d-inline-block" href="SingleBlog?postID=${be.newsId}">
                                                <h3>${be.getTitle()}</h3>
                                            </a>
                                            <p class="Content-news">${be.getContent()}</p>
                                            <a class="read_more" href="SingleBlog?postID=${be.newsId}">Đọc Thêm</a>
                                        </div>
                                    </div>
                                </c:forEach>
            ...
            <div data-scroll-index='1' class="make_donation_area section_padding">
                <div class="container">
                    <div class="campaign-header">Kêu gọi quyên góp từ tài khoản Từ Thiện</div>

                    <div class="campaign-container">
                        <div class="campaign-section">
                            <i class="fas fa-users"></i>
                            <h3>Đăng ký Tổ chức</h3>
                            <p>Tạo tài khoản và tài khoản người dùng trên ứng dụng Thiện Nguyện để bắt đầu sử dụng các tính năng gây quỹ minh bạch.</p>
                        </div>
                        <div class="campaign-section">
                            <i class="fas fa-hands-helping"></i>
                            <h3>Tạo chiến dịch</h3>
                            <p>Thiết kế, quản lý mục tiêu gây quỹ và đăng tải, cập nhật các sự kiện từ thiện với các bước đơn giản.</p>
                        </div>
                        <div class="campaign-section">
                            <i class="fas fa-share-square"></i>
                            <h3>Chia sẻ chiến dịch</h3>
                            <p>Chia sẻ chiến dịch của bạn với bạn bè, gia đình và cộng đồng qua mạng xã hội. Đồng thời, kêu gọi sự ủng hộ để lan tỏa chiến dịch.</p>
                        </div>
                    </div>

                    <div style="text-align: center;">
                        <c:if test="${empty userOr || userOr.getOrganizationStatus() == 'inactive'}">
                            <a href="regisorg" class="campaign-btn">Đăng ký ngay</a>
                        </c:if>
                        <c:if test="${!empty userOr && userOr.getOrganizationStatus() == 'active'}">
                            <div style="display: flex; justify-content: center">
                                <div style="color: white; width: 170px" onclick="RejectAction('organexist')" class="campaign-btn">Đăng ký ngay</div>
                            </div>
                        </c:if>
                        <c:if test="${userOr.getOrganizationStatus() == 'pending'}">
                            <div style="display: flex; justify-content: center">
                                <div style="color: white; width: 170px" onclick="RejectAction('organpending')" class="campaign-btn">Đăng ký ngay</div>
                            </div>
                        </c:if>
                    </div>
            ...
            <div id="chat-bubble" class="chat-bubble">
                ...
                <div class="chat-body" id="chat-body">
                    <p>Chào mừng! Hãy chọn một câu hỏi để nhận câu trả lời.</p>
                </div>
                <div class="chat-footer">
                    <select id="questionSelect" onchange="getAnswer()">
                        <option value="">Chọn một câu hỏi</option>
                        <option value="register">Đăng ký tài khoản</option>
                        <option value="contact">Cách để liên hệ</option>
                        <option value="resetPassword">Lấy lại mật khẩu</option>
                    </select>
                </div>
            </div>
...
//        };
    ...
    <script>
        const answers = {
            register: "Để đăng ký tài khoản, vui lòng truy cập vào trang đăng ký của chúng tôi tại <a href='register'>đây</a>.",
            contact: "Bạn có thể liên hệ với chúng tôi qua email tại team4charifit@gmail.com hoặc gọi số 0999999999 hoặc đến trang liên hệ tại <a href='contact'>đây</a>.",
            resetPassword: "Để lấy lại mật khẩu, vui lòng truy cập vào trang đặt lại mật khẩu tại <a href='resetPassword'>đây</a>."
        };
        ...
        function getAnswer() {
            ...
            if (selectedQuestion) {
                ...
                messageElement.innerHTML = answer; // Sử dụng innerHTML để chèn HTML
