            ...
            <div class="related-articles">
                ...
                <c:forEach var="o" items="${organiztions}">
                    <div class="article-item">
                        ...
                        <div>
                            <a class="article-title" href="/article1">
                                    ...
                                    function setMaxDate() {
                                        ...
                                        const currentDate = `${yyyy}-${mm}-${dd}`;
                                            ...
                                            document.getElementById('registerForm').addEventListener('submit', function (event) {
                                                ...
                                                document.getElementById('errRepName').textContent = '';
                                                ...
                                                if (isEmpty(representativeName)) {
                                                    document.getElementById('errRepName').textContent = 'Tên người đại diện không được để trống';
                                                    isValid = false;
                                                }
