                ...
                <div class="profile-card">
                    <div class="profile-info">
                        ...
                        <div class="info-group">
                            ...
                            <div class="info-value">
                                <input type="tel" id="userPhone" name="phone" value="${acc.phone}" maxlength="10">
                            </div>
                        </div>
                        ...
                        <div class="info-group">
                            ...
                            <div class="info-value">
                                <input type="text" id="staffAddress" name="address" value="${acc.adrees}">
                            </div>
                        </div>
                        ...
                        <div class="info-group">
                            ...
                            <div class="info-value">
                                <input type="text" id="staffDepartment" value="${acc.role}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="info-group">
                            ...
                            <div class="info-value inline-radio">
                                <input type="radio" id="genderMale" name="gender" value="Male" ${acc.gender == 'Male' ? 'checked' : ''}>
                                <label for="genderMale">Nam</label>

                                <input type="radio" id="genderFemale" name="gender" value="Female" ${acc.gender == 'Female' ? 'checked' : ''}>
                        ...
                        <div class="edit-profile">
                            <button class="btn btn-home" onclick="event.preventDefault(); window.location.href = 'home';">Quay về trong chủ</button>
                        </div>
                    </div>
                </div>
            </form>
