...
.cv-personal-info, .cv-skills {
    text-align: left;
    margin-top: 20px;
    color: white;
}

.cv-personal-info h3, .cv-skills h3 {
    font-size: 18px;
    margin-bottom: 10px;
    color: white;
}
...
.cv-experience h3, .cv-education h3 {
    font-size: 18px;
    margin-bottom: 5px;
}
    ...
    <![endif]-->
        ...
        <div style="margin-top: 150px; margin-bottom: 150px" class="cv-container">
        <div class="cv-sidebar">
            <div class="cv-profile-pic">
                <img src="images/emzai.jpg" alt="Volunteer Photo">
            </div>
            <h1 class="cv-name">NGUYỄN TRUNG TIẾN</h1>
            <h3 class="cv-job-title">J97</h3>
            <div class="cv-personal-info">
                <h3>Personal Information</h3>
                <p style="color: white"><strong >Location: </strong>Hải Phòng</p>
                <p style="color: white"><strong>Phone: </strong> 098 999 0009</p>
                <p style="color: white"><strong>Email: </strong> your-mail@google.com</p>
                <p style="color: white"><strong>Gender: </strong> Male</p>
            </div>
            <div class="cv-skills">
                <h3>Skills</h3>
                <ul>
        ...
        <div class="cv-main-content">
            <div class="cv-section">
                ...
                <div class="cv-experience">
                    <span>2013-05 to 2013-09</span>
                    <h3>Part-time English Teaching Assistant</h3>
                    <p><strong>ABC Center</strong></p>
                    <ul>
                        <li>Build detailed lecture schedules.</li>
                        <li>Assist with checking writings, scoring, and assessment.</li>
                        <li>Help students improve English by providing feedback.</li>
                    </ul>
                </div>
            </div>
            <div class="cv-section">
                ...
                <div class="cv-education">
                    <span>2013-10 to 2015-09</span>
                    <h3>Bachelor of English Language</h3>
                    <p><strong>University NYC</strong></p>
                    <p>Final result: 8.5</p>
                </div>
            </div>
            <div class="cv-section">
                <h2 class="cv-section-title">COMMUNITY ACTIVITY</h2>
                <!-- Add community activity details here -->
            </div>
        </div>
    </div>
        <footer class="footer">
