                        ...
                        <div class="form-container">
                            ...
                            <form action="event-create" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="quantityNeeded" name="quantityNeeded" required>
                                </div>
                                
                                <div class="form-group">
                                    <label for="quantityProvided">Quantity Provided</label>
                                    <input type="number" class="form-control" id="quantityProvided" name="quantityProvided" required>
                                </div>
