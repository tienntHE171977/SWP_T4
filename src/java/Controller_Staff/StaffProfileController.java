 ...
 * @author FPT
 */
@WebServlet(name = "StaffProfileController", urlPatterns = {"/staffProfile"})
public class StaffProfileController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet StaffProfileController</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet StaffProfileController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int staffId = (Integer) request.getSession().getAttribute("staffId");
            ...
            Staff staff = staffDAO.getStaffProfile(staffId);
