...
public class ProjectDAO extends DBContext {
    ...
    public Campaign getCamById(int campaignId) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                c.setProjectId(getProjectById(rs.getInt("project_id")));
    ...
    public void deletePrj(int projectid) {
