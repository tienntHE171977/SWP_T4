...
public class ProjectCategoryDAO extends DBContext {
    ...
    public void deleteProjectCategory(int projectId, int categoryId) {
    ...
    public void deleteAllProjectCate(int projectId) {
        String sql = "DELETE FROM ProjectCategories WHERE project_id = ?";
        try (PreparedStatement statement = connection.prepareStatement(sql)) {
            statement.setInt(1, projectId);
            statement.executeUpdate();
        } catch (SQLException e) {
