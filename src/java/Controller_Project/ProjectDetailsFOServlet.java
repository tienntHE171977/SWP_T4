...
@WebServlet("/project-details-fo")
public class ProjectDetailsFOServlet extends HttpServlet {
        ...
        if (projectIdStr != null && !projectIdStr.isEmpty()) {
            try {
                ...
                if (project != null) {
                    ...
                    // Forward to JSP
                    request.getRequestDispatcher("/project-details-fo.jsp").forward(request, response);
                } else {
                    // Project not found
