 ...
 * @author admin
 */
@WebServlet(name = "CampaignMember", urlPatterns = {"/CampaignMember"})
public class CampaignMember extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("campaign_members.jsp").forward(request, response);
    }
