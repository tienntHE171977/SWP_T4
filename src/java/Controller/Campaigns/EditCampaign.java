 ...
 * @author admin
 */
@WebServlet(name = "EditCampaign", urlPatterns = {"/EditCampaign"})
public class EditCampaign extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        dao.updateCampaign(campaignId, campaignName, address, description, job);

        response.sendRedirect("CampaignManage?PID=" + PID);
