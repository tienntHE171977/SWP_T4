 ...
 * @author admin
 */
@WebServlet(name = "CampaignSingle", urlPatterns = {"/CampaignSingle"})
public class CampaignSingle extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (campaignId != null && !campaignId.isEmpty()) {
            // Nếu có campaignId, lấy thông tin chi tiết của campaign
            Model.Campaign detail = dao.getCampaignByID(campaignId);
            request.setAttribute("campaignDetail", detail);
        }
