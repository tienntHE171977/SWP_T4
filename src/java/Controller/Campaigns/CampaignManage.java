 ...
 * @author admin
 */
@WebServlet(name = "CampaignManage", urlPatterns = {"/CampaignManage"})
public class CampaignManage extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<ProjectCampaign> listp = dao.getAllProjects(userId);
        ...
        request.getRequestDispatcher("Campaign/campaign_manage.jsp").forward(request, response);
    }
