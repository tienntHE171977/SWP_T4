 ...
 * @author admin
 */
@WebServlet(name = "BlogSort", urlPatterns = {"/BlogSort"})
public class BlogSort extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("Title".equals(sortBy)) {
            list = dao.SortPostByNewsName(index);
        } else if ("Date".equals(sortBy)) {
            list = dao.SortPostByNewsDate(index);
        }
