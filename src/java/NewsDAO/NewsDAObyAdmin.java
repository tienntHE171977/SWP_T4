 ...
 * @author admin
 */
public class NewsDAObyAdmin extends DBContext{
...
// For news
    ...
    public List<News> getAllNewsbyAdminwithOn(int index) {
        List<News> list = new ArrayList<>();
        String query = "select*from News\n"
                + "WHERE status = 'on'\n"
                + "ORDER BY news_id ASC\n"
    ...
    public int getTotalNewswithOff() {
        String query = "select count(*) from News\n"
                + " where status = 'off'";
        try {
    ...
    public List<News> getAllNewsbyAdminwithOff(int index) {
        List<News> list = new ArrayList<>();
        String query = "select*from News\n"
                + "WHERE status = 'off'\n"
                + "ORDER BY news_id ASC\n"
    ...
    public void insertNews(String title, String category_id, String content, String message, int author_id, String image) {
