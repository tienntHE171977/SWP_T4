                        ...
                        <div class="single_cause">
                            ...
                            <div class="causes_content">
                                ...
                                <div class="tab-container">
                                    ...
                                    <div id="Campaigns" class="tabcontent" style="height: 300px">
                                        ...
                                        <ul class="info-list">
                                            <li>
                                                ...
                                                <div class="details">Thông tin chi tiết của danh sách 1.</div>
                                            </li>
                                            <li>
                                    ...
                                    <div id="Reviews" class="tabcontent" style="height: 300px; overflow-y: auto;">
                                        <h4>Project Reviews</h4>
                                        <c:forEach var="review" items="${projectReviews}">
                                            <div class="review-item">
                                                <div class="rating">Rating: ${review.rating}/5</div>
                                                <div class="comment">${review.comment}</div>
                                                <div class="user-info">By User ID: ${review.userId} on <fmt:formatDate value="${review.createdAt}" pattern="dd/MM/yyyy"/></div>
                                            </div>
                                        </c:forEach>
                                    </div>
                                </div>
